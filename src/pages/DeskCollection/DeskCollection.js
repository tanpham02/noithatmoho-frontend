...
import DeskCollection from "../../Components/DeskCollection/DeskCollection"
...
const DeskCollectionPage = ({datas, dataTypes, accountInfos, localeLogos, bannerServices }) => {
    useEffect(() => {
        document.title = "Bàn Làm Việc, Bàn Văn Phòng Hiện Đại 2023 - Ưu Đãi 5% - Nội Thất MOHO"
    }, [])
