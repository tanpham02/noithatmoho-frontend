...
const ShoesCabinetPage = ({ localeLogos, bannerServices, datas, dataTypes, accountInfos }) => {

    useEffect(() => {
        document.title = "Tủ Giày Dép Gỗ Trang Trí Đẹp, Thông Minh và Hiện Đại - Nội Thất MOHO"
    }, [])
