...
import TreeFlowers from "../../Components/TreeFlowers/TreeFlowers"
...
const TreeFlowersPage = ({datas, dataTypes, accountInfos, localeLogos, bannerServices }) => {
    useEffect(() => {
        document.title = "Đồ Trang Trí / Đồ Decor: Cây - Hoa"
    }, [])
