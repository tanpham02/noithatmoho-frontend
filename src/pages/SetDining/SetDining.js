...
import SetDining from "../../Components/SetDining/SetDining"
...
const SetDiningPage = ({datas, dataTypes, accountInfos, localeLogos, bannerServices }) => {
    useEffect(() => {
        document.title = "Bộ Bàn Ăn Gỗ Tự Nhiên - Bàn 4, 6 Ghế Ăn Đẹp, Hiện Đại - Nội Thất MOHO"
    }, [])
