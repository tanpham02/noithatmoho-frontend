...
import SofaTableFilter from "./SofaTableFilter"

const SofaTable = ({ datas, dataTypes, filterCategories, filterPrices, filterSort }) => {
    ...
    return (
        <main className="container product-lists">
            <img className="img-page" src="/assets/img/img-page/ban-sofa.png" alt="Bàn Sofa - Bàn Cafe - Bàn Trà" />
            <div className="grid">
                <div className="grid__row">
                    <h2 className="products__title px--16">Bàn Sofa - Bàn Cafe - Bàn Trà</h2>
                    <SofaTableFilter
                        dataKoges={dataKoges}
