...
import ChairDiningFilter from "./ChairDiningFilter"

const ChairDining = ({ datas, dataTypes, filterCategories, filterPrices, filterSort }) => {
    ...
    useEffect(() => {
        ...
        const results = datas.filter((data, index) => {
            const kitchenWare = dataTypes.find(type => type.id === 13)
    ...
    return (
        <main className="container product-lists">
            <img className="img-page" src="/assets/img/img-page/collection_chair-dining.png" alt="Ghế Ăn" />
            <div className="grid">
                <div className="grid__row">
                    <h2 className="products__title px--16">Ghế Ăn</h2>
                    <ChairDiningFilter
                        dataKoges={dataKoges}
...
export default memo(ChairDining)