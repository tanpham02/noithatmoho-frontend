...
import CabinetMakeUpFilter from "./CabinetMakeUpFilter"

const CabinetMakeUp = ({ datas, dataTypes, filterCategories, filterPrices, filterSort }) => {
    ...
    useEffect(() => {
        ...
        const results = datas.filter((data, index) => {
            const kitchenWare = dataTypes.find(type => type.id === 19)
    ...
    return (
        <main className="container product-lists">
            <img className="img-page" src="/assets/img/img-page/collection_cabinet-makeup.png" alt="Tủ Trang Điểm" />
            <div className="grid">
                <div className="grid__row">
                    <h2 className="products__title px--16">Tủ Trang Điểm</h2>
                    <CabinetMakeUpFilter
                        dataKoges={dataKoges}
...
export default memo(CabinetMakeUp)