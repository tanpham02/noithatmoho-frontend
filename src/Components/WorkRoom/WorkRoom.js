...
const WorkRoom = ({ datas, dataTypes, dataGroupTypes, filterCategories, filterPrices, filterSort }) => {
    const [id, setId] = useState([])
    const [dataWorkRoom, setDataWorkRoom] = useState([])
    ...
    useEffect(() => {
        ...
        setDataWorkRoom(prev => [...prev, ...results])
    }, [datas, id])
    ...
    return (
        <main className="container product-lists">
            <img className="img-page" src="/assets/img/img-page/work-room.png" alt="Phòng Làm Việc" />
            <div className="grid">
                <div className="grid__row">
                    <h2 className="products__title px--16">Phòng Làm Việc</h2>
                    <WorkRoomFilter
                        dataWorkRoom={dataWorkRoom}
