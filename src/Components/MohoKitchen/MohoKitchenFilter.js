...
const MohoKitchenFilter = ({ dataMohoKitchen, onGetData, filterCategories, filterPrices, filterSort }) => {
    ...
    useEffect(() => {
        if (sort !== '') {
            const output = dataMohoKitchen.sort((a, b) => {
                if (sort === 'Tăng Dần') {
...
export default memo(MohoKitchenFilter)