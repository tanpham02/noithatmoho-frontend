...
import ChairPadCushionFilter from "./ChairPadCushionFilter"

const ChairPadCushion = ({ datas, dataTypes, filterCategories, filterPrices, filterSort }) => {
    ...
    useEffect(() => {
        ...
        const results = datas.filter((data, index) => {
            const kitchenWare = dataTypes.find(type => type.id === 28)
    ...
    return (
        <main className="container product-lists">
            <img className="img-page" src="/assets/img/img-page/vase-bowl.png" alt="Đệm Ngồi - Gối Tựa" />
            <div className="grid">
                <div className="grid__row">
                    <h2 className="products__title px--16">Đệm Ngồi - Gối Tựa</h2>
                    <ChairPadCushionFilter
                        dataKoges={dataKoges}
...
export default memo(ChairPadCushion)