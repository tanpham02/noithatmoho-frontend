...
import ChairOfficeFilter from "./ChairOfficeFilter"

const ChairOffice = ({ datas, dataTypes, filterCategories, filterPrices, filterSort }) => {
    ...
    return (
        <main className="container product-lists">
            <img className="img-page" src="/assets/img/img-page/collection_chair-office.png" alt="Ghế Văn Phòng" />
            <div className="grid">
                <div className="grid__row">
                    <h2 className="products__title px--16">Ghế Văn Phòng</h2>
                    <ChairOfficeFilter
                        dataKoges={dataKoges}
...
export default memo(ChairOffice)