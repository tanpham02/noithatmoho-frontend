...
import TreeFlowersFilter from "./TreeFlowersFilter"

const TreeFlowers = ({ datas, dataTypes, filterCategories, filterPrices, filterSort }) => {
    ...
    useEffect(() => {
        ...
        const results = datas.filter((data, index) => {
            const kitchenWare = dataTypes.find(type => type.id === 27)
    ...
    return (
        <main className="container product-lists">
            <img className="img-page" src="/assets/img/img-page/vase-bowl.png" alt="Cây - Hoa" />
            <div className="grid">
                <div className="grid__row">
                    <h2 className="products__title px--16">Cây - Hoa</h2>
                    <TreeFlowersFilter
                        dataKoges={dataKoges}
...
export default memo(TreeFlowers)