...
import TvCabinetFilter from "./TvCabinetFilter"

const TvCabinet = ({ datas, dataTypes, filterCategories, filterPrices, filterSort }) => {
    ...
    useEffect(() => {
        ...
        const results = datas.filter((data, index) => {
            const kitchenWare = dataTypes.find(type => type.id === 10)
    ...
    return (
        <main className="container product-lists">
            <img className="img-page" src="/assets/img/img-page/tu-ke-tivi.png" alt="Tủ Kệ Tivi" />
            <div className="grid">
                <div className="grid__row">
                    <h2 className="products__title px--16">Tủ Kệ Tivi</h2>
                    <TvCabinetFilter
                        dataKoges={dataKoges}
