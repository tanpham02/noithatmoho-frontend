...
const VlineCollection = ({ datas, dataTypes, filterCategories, filterPrices, filterSort }) => {
    ...
    return (
        <main className="container product-lists">
            <img className="img-page" src="/assets/img/img-page/collection_vline.png" alt="VLINE Collection" />
            <div className="grid">
                <div className="grid__row">
                    <h2 className="products__title px--16">VLINE Collection</h2>
                    <VlineCollectionFilter
                        dataKoges={dataKoges}
...
export default memo(VlineCollection)