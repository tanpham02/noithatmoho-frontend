...
import ShoesCabinetFilter from "./ShoesCabinetFilter"

const ShoesCabinet = ({ datas, dataTypes, filterCategories, filterPrices, filterSort }) => {
    ...
    useEffect(() => {
        ...
        const results = datas.filter((data, index) => {
            const kitchenWare = dataTypes.find(type => type.id === 11)
    ...
    return (
        <main className="container product-lists">
            <img className="img-page" src="/assets/img/img-page/tu-giay-tu-trang-tri.png" alt="Tủ Giày - Tủ Trang Trí" />
            <div className="grid">
                <div className="grid__row">
                    <h2 className="products__title px--16">Tủ Giày - Tủ Trang Trí</h2>
                    <ShoesCabinetFilter
                        dataKoges={dataKoges}
...
export default memo(ShoesCabinet)