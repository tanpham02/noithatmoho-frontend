...
import HobroCollectionFilter from "./HobroCollectionFilter"

const HobroCollection = ({ datas, dataTypes, filterCategories, filterPrices, filterSort }) => {
    ...
    return (
        <main className="container product-lists">
            <img className="img-page" src="/assets/img/img-page/collection_hobro.png" alt="HOBRO Collection" />
            <div className="grid">
                <div className="grid__row">
                    <h2 className="products__title px--16">HOBRO Collection</h2>
                    <HobroCollectionFilter
                        dataKoges={dataKoges}
...
export default memo(HobroCollection)